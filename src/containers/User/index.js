    ...
    <>
      ...
      <div className='container flex mt-12'>
        <div className='mr-10' style={{ width: '368px' }}>
          <div className='max-w-sm my-4 overflow-hidden bg-white rounded-lg shadow-lg'>
            ...
            <div className='flex items-center px-6 py-3 bg-gray-900'>
              ...
              <h1 className='mx-3 text-lg font-semibold text-white'>Fapping</h1>
            </div>
            <div className='px-6 py-4'>
              ...
              <div className='flex items-center mt-4 text-gray-700'>
                ...
                <h1 className='px-2 text-xs'>BrosCode</h1>
              </div>
              <div className='flex items-center mt-4 text-gray-700'>
                <svg className='w-6 h-6 fill-current' viewBox='0 0 512 512'>
                  <path d='M256 32c-88.004 0-160 70.557-160 156.801C96 306.4 256 480 256 480s160-173.6 160-291.199C416 102.557 344.004 32 256 32zm0 212.801c-31.996 0-57.144-24.645-57.144-56 0-31.357 25.147-56 57.144-56s57.144 24.643 57.144 56c0 31.355-25.148 56-57.144 56z' />
                </svg>
                <h1 className='px-2 text-xs'>Ho Chi Minh</h1>
              </div>
              <div className='flex items-center mt-4 text-gray-700'>
                <svg className='w-6 h-6 fill-current' viewBox='0 0 512 512'>
                  <path d='M437.332 80H74.668C51.199 80 32 99.198 32 122.667v266.666C32 412.802 51.199 432 74.668 432h362.664C460.801 432 480 412.802 480 389.333V122.667C480 99.198 460.801 80 437.332 80zM432 170.667L256 288 80 170.667V128l176 117.333L432 128v42.667z' />
                </svg>
                <h1 className='px-2 text-xs'>trump@broscode.com</h1>
              </div>
            </div>
          </div>
          <div class='mb-2 overflow-hidden border border-solid rounded-lg shadow-lg border-grey-light '>
            <div class='px-2 py-3 bg-gray-200 border-b border-solid bg-grey-lighter border-grey-light'>
              Progress
            </div>
            <div class='flex items-center p-3 px-4 border-b border-gray-200'>
              <FaQuestion />{' '}
              <span className='ml-3 text-md'>Solved Question</span>
              <span className='px-2 ml-auto text-xs text-white bg-green-500 rounded-lg '>
                34 / 1000
              </span>
            </div>
            <div class='flex items-center p-3 px-4 border-b border-gray-200'>
            ...
            <div class='flex items-center p-3 px-4 border-b border-gray-200'>
              ...
              <span className='px-2 ml-auto text-xs text-white bg-blue-500 rounded-lg '>
                89%
              </span>
            </div>
          ...
          <div class='mb-2 overflow-hidden border border-solid rounded-lg shadow-lg border-grey-light '>
            ...
            <div class='flex items-center p-3 px-4 border-b border-gray-200'>
              ...
              <span className='px-2 ml-auto text-xs font-bold text-white bg-green-500 rounded-lg '>
                1487
              </span>
            </div>
            <div class='flex items-center p-3 px-4 border-b border-gray-200'>
            ...
            <div class='flex items-center p-3 px-4 border-b border-gray-200'>
              ...
              <span className='px-2 ml-auto text-xs font-bold text-white bg-blue-500 rounded-lg '>
                0
              </span>
            </div>
          </div>
        ...
        <div className='flex-grow'>
          <div class='my-4 mb-2 overflow-hidden border border-solid rounded-lg shadow-lg border-grey-light '>
            <div class='px-2 py-3 bg-gray-200 border-b border-solid bg-grey-lighter border-grey-light'>
          ...
          <div class='my-4 mb-2 overflow-hidden border border-solid rounded-lg shadow-lg border-grey-light '>
            ...
            <div class='flex items-center p-3 px-4 border-b border-gray-200'>
              ...
              <div className='ml-auto'>
                <span className='px-2 py-1 mr-3 text-xs font-bold text-white bg-blue-500 rounded-lg'>
                  c++
                </span>

                <span className='px-2 py-1 text-xs font-bold text-white bg-green-500 rounded-lg'>
                  Accepted
                </span>
              </div>
            </div>
