      ...
      <div className='container mt-12 flex'>
        <div className='mr-10' style={{ width: '368px' }}>
          ...
          <div class='mb-2 border-solid border-grey-light  border shadow-lg rounded-lg overflow-hidden'>
            ...
            <div class='p-3 flex items-center px-4 border-b border-gray-200'>
              ...
              <span className=' ml-auto px-2 bg-green-500 rounded-lg text-white text-xs'>
                34 / 1000
              </span>
            </div>
            <div class='p-3 flex items-center px-4 border-b border-gray-200'>
            ...
            <div class='p-3 flex items-center px-4 border-b border-gray-200'>
              ...
              <span className=' ml-auto px-2 bg-blue-500 rounded-lg text-white text-xs'>
                89%
              </span>
            </div>
          ...
          <div class='mb-2 border-solid border-grey-light  border shadow-lg rounded-lg overflow-hidden'>
            ...
            <div class='p-3 flex items-center px-4 border-b border-gray-200'>
              ...
              <span className=' ml-auto px-2 bg-green-500 rounded-lg text-white font-bold text-xs'>
                1487
              </span>
            </div>
            <div class='p-3 flex items-center px-4 border-b border-gray-200'>
            ...
            <div class='p-3 flex items-center px-4 border-b border-gray-200'>
              ...
              <span className=' ml-auto px-2 bg-blue-500 rounded-lg text-white font-bold text-xs'>
                0
              </span>
            </div>
          </div>
        ...
        <div className='flex-grow'>
          ...
          <div class='mb-2 border-solid border-grey-light  border shadow-lg rounded-lg overflow-hidden my-4'>
            ...
            <div class='p-3 flex items-center px-4 border-b border-gray-200'>
              <span className='ml-1 text-xs text-gray-800 font-bold'>
                Two Sum
              </span>
              <div className='ml-auto'>
                <span className='px-2 py-1 mr-3 bg-blue-500 rounded-lg text-white font-bold text-xs'>
                  c++
                </span>

                <span className='px-2 py-1 bg-green-500 rounded-lg text-white font-bold text-xs'>
                  Accepted
                </span>
              </div>
            </div>
